...
func (a *Actor) registerInstanceRoutes(r *gin.RouterGroup) {
...
func (a *Actor) startServiceInstance(c *gin.Context)   { a.instanceContainerAction(c, "start") }
func (a *Actor) stopServiceInstance(c *gin.Context)    { a.instanceContainerAction(c, "stop") }
func (a *Actor) restartServiceInstance(c *gin.Context) { a.instanceContainerAction(c, "restart") }
