...
func TestBuildContainerSpec(t *testing.T) {
	...
	if spec.Labels[model.OpsInstanceLabel] != "abc-123" {
...
func TestFindContainerForInstance(t *testing.T) {
	containers := []types.Container{
		{ID: "c1", Labels: map[string]string{model.OpsInstanceLabel: "inst-1"}},
		{ID: "c2", Labels: map[string]string{model.OpsInstanceLabel: "inst-2"}},
	}
...
func TestBuildContainerDetail(t *testing.T) {
	c := types.ContainerJSON{
		...
		Config: &container.Config{
			...
			Labels: map[string]string{model.OpsInstanceLabel: "abc-123"},
		},
	...
	if detail.Labels[model.OpsInstanceLabel] != "abc-123" {
